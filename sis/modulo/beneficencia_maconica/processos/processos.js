$('#tabela_processos_pendentes').DataTable({
    ajax: "modulo/beneficencia_maconica/processos/tabela_processos_pendentes.php",
...
$('#tabela_consultar_processos').DataTable({
    ajax: "modulo/beneficencia_maconica/processos/tabela_consultar_processos.php",
    initComplete: function () {
        App.init();
    },
    order: [[0, "desc"]],
    ...
    swal({
        ...
        closeOnCancel: true
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: 'modulo/beneficencia_maconica/processos/control_processos.php',
                        ...
                        success: function (res) {
                            ...
                            if (resposta.sucesso === true) {
                                ...
                                $.ajax({
                                    url: 'modulo/beneficencia_maconica/processos/processos_pendentes.php',
                                    success: function (res) {
