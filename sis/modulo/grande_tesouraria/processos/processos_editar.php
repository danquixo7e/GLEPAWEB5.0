...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/grande_tesouraria/processos/processos_editar.php?id=<?php echo $value['id'] ;?>" class="ajaxify">Editar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    ...
    <div class="btn-group pull-right">
        <a href="modulo/grande_tesouraria/processos/processos_pendentes.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
</h3>
<div class="row">
    <div class="col-md-12">
