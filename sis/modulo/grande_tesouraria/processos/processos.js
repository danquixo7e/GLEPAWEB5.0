$('#tabela_processos_pendentes').DataTable({
    ajax: "modulo/grande_tesouraria/processos/tabela_processos_pendentes.php",
...
$('#tabela_consultar_processos').DataTable({
    ajax: "modulo/grande_tesouraria/processos/tabela_consultar_processos.php",
    initComplete: function () {
        App.init();
    },
    order: [[0, "desc"]],
    ...
    swal({
        ...
        closeOnCancel: true
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: 'modulo/grande_tesouraria/processos/control_processos.php',
                        ...
                        success: function (res) {
                            ...
                            if (resposta.sucesso === true) {
                                ...
                                $.ajax({
                                    url: 'modulo/grande_tesouraria/processos/processos_pendentes.php',
                                    success: function (res) {
