...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_dados.php?id=<?php echo $value['id_processo'] ;?>" class="ajaxify">Dados Pessoais</a>
        </li>
    </ul>
