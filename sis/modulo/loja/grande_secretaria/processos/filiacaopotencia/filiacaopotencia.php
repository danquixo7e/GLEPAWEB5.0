...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_iniciar.php" class="ajaxify">Filiação</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
...
<div class="portlet light portlet-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green bold uppercase">Filiação</span>
        </div>
    </div>
    <div class="portlet-body">
        <div class="mt-element-step">
            <div class="row step-line">
                ...
                <div class="col-md-3 mt-step-col active">
                    ...
                    <div class="mt-step-content font-grey-cascade">Kit para filiação de outra potência <br> R$ <?php echo number_format(get('glepaweb_tipo_cobranca', 'id', '14', 'valor'), 2, ',', '.'); ?> + R$ <?php echo number_format(get('glepaweb_tipo_cobranca', 'id', '9', 'valor'), 2, ',', '.') ; ?> <br>Referente a inscrição na Beneficência Maçônica caso tenha menos de 65 anos</div>
                </div>
                <div class="col-md-3 mt-step-col active">
        ...
        <hr>
        <a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_cpf.php" class="btn btn-lg blue margin-top-20 ajaxify"> Iniciar Processo <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
