                ...
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $dados['enviado'] !== '1') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_dados.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $anexos['enviado'] !== '1') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_anexos.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $historico['enviado'] === '0') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_historico.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $value['data_prevista'] == '') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaopotencia/filiacaopotencia_data.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
