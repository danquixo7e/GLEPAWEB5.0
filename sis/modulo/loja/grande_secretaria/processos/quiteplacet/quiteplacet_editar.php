...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/quiteplacet/quiteplacet_editar.php?id=<?php echo $value['id']; ?>" class="ajaxify">Acessar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
    ...
    <div class="search-table table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                <tr>
                    <td class="table-status">
                        ...
                        if ($value['id_status'] === '3') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/quiteplacet/quiteplacet_membro.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                    ...
                    <td class="table-desc"> Dados pessoais do <?php echo get(glepaweb_membros, id, $value['id_membro'], nome) ;?> e o nome simbólico deste mestre</td>
                ...
                <tr>
                    <td class="table-status">
                        <a href="publico/imprimir/processos/quiteplacet.php?id=<?php echo $value['id']; ?>" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>
                    </td>
                    ...
                    <td class="table-desc">Imprimir a concessão do Quite Placet</td>
