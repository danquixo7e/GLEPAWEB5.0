...
<div class="portlet light portlet-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green bold uppercase">FILIAÇÃO DE MEMBRO INATIVO</span>
        </div>
    </div>
    <div class="portlet-body">
        <div class="mt-element-step">
            <div class="row step-line">
                <div class="col-md-2 mt-step-col first done">
                    ...
                    <div class="mt-step-content font-grey-cascade">Preenchendo o cadastro do membro <br> (Necessita do Quite Placet)</div>
                </div>
                ...
                <div class="col-md-3 mt-step-col active">
                    ...
                    <div class="mt-step-content font-grey-cascade">Kit para filiação <br> R$ <?php echo number_format(get('glepaweb_tipo_cobranca', 'id', '11', 'valor'), 2, ',', '.'); ?> + R$ <?php echo number_format(round((get('glepaweb_tipo_cobranca', 'id', '9', 'valor') / 2),1), 2, ',', '.') ; ?> <br>Referente a inscrição na Beneficência Maçônica caso tenha menos de 65 anos (Isento caso o Quite Placet tenha no máximo 30 dias) </div>
                </div>
                <div class="col-md-3 mt-step-col active">
                    <div class="mt-step-number bg-white">3</div>
        ...
        <hr>
        <a href="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo_cpf.php" class="btn btn-lg blue margin-top-20 ajaxify"> Iniciar Processo <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
