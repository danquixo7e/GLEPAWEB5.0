...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo.php" class="ajaxify">Filiação</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo_cpf.php" class="ajaxify">Abrir Processo</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo_cpf.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Filiação
    <small>Membro</small>
</h3>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_filiacaoinativo" name="<?php echo $id; ?>">
            <div class="portlet-title">
                <div class="caption">
                    <i class=" icon-layers font-green"></i>
                    <span class="caption-subject font-green bold uppercase">Filiação - <span class="step-title"> Passo 1 de 3 </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="formFiliaçãoInativo" name="<?php echo $id ;?>" >
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> FILIAÇÃO DE MEMBRO INATIVO </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Data do Cerimonial:</label>
    ...
    <script src="modulo/loja/grande_secretaria/processos/filiacaoinativo/filiacaoinativo.js" type="text/javascript"></script>