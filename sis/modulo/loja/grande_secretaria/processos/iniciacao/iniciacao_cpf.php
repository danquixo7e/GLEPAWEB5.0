...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_cpf.php" class="ajaxify">Abrir Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao.php" class="btn btn-outline btn-sm blue ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Iniciação
