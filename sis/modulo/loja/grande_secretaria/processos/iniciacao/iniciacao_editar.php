...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_editar.php?id=<?php echo $value['id']; ?>" class="ajaxify">Analisar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
    ...
    <div class="search-table table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $dados['enviado'] !== '1') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_dados.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                    ...
                    <td class="table-desc"> Dados pessoais do <?php echo ($value['id_tipo'] === '1' ? 'candidato' : get(glepaweb_membros, id, $value['id_membro'], nome)) ;?> </td>
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if (($value['id_status'] === '1' || $value['id_status'] === '3') && $anexos['enviado'] !== '1') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_anexos.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                ...
                if ($value['id_etapa'] > '3' || $value['id_status'] > '1') {
                ?>
                <tr>
                    <td class="table-status">
                        <?php
                        if ((($value['id_status'] === '1' || $value['id_status'] === '3') && $value['id_etapa'] === '4') && $value['data_prevista'] == '') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_data.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
