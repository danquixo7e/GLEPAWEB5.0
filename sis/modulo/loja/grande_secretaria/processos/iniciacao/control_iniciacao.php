        ...
        if ($readDocumentos) {
            ...
            if ($_FILES[$documento]['tmp_name']) {
                ...
                if ($anexos['rg'] != '' && $anexos['certidao'] != '' && $anexos['renda'] != '' && $anexos['medico'] != '' && $anexos['certidao_negativa_judiciario'] != '' && $anexos['certidao_negativa_federal'] != '' && $anexos['certidao_negativa_protesto'] != '' && $anexos['proposta1'] != '' && $anexos['proposta2'] != '' && $anexos['proposta3'] != '' && $anexos['proposta4'] != '') {
                    if (($demolay == '1' && $anexos['certidao_demolay'] != '') && ($militar == '1' && $anexos['certidao_militar'] != '') && ($idade <= 65 && $anexos['beneficencia'] != '')) {
                        $retorno['redireciona'] = true;
                    } else {
                        if (($demolay == '1' && $anexos['certidao_demolay'] != '') && ($militar == '0' && $anexos['certidao_militar'] == '') && ($idade <= 65 && $anexos['beneficencia'] != '')) {
                            $retorno['redireciona'] = true;
                        } else {
                            if (($demolay == '0' && $anexos['certidao_demolay'] == '') && ($militar == '1' && $anexos['certidao_militar'] != '') && ($idade <= 65 && $anexos['beneficencia'] != '')) {
                                $retorno['redireciona'] = true;
                            } else {
                                if (($demolay == '0' && $anexos['certidao_demolay'] == '') && ($militar == '0' && $anexos['certidao_militar'] == '') && ($idade <= 65 && $anexos['beneficencia'] != '')) {
                                    $retorno['redireciona'] = true;
                                } else {
                                    if (($demolay == '1' && $anexos['certidao_demolay'] != '') && ($militar == '1' && $anexos['certidao_militar'] != '') && ($idade > 65 && $anexos['beneficencia'] == '')) {
                                        $retorno['redireciona'] = true;
