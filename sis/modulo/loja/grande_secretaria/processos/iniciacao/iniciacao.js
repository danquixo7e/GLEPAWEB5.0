...
formCpf.validate({
    ...
    submitHandler: function () {
        ...
        swal({
            ...
            if (isConfirm) {
                formCpf.ajaxSubmit({
                    url: 'modulo/loja/grande_secretaria/processos/iniciacao/control_iniciacao.php',
                    data: {acao: 'sendCpf'},
                    type: 'POST',
                    beforeSend: function () {
                    ...
                    success: function (res) {
                        ...
                        if (resposta.sucesso === true) {
                            ...
                            $.ajax({
                                url: 'modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_dados.php?id=' + resposta.id,
                                success: function (res) {
                    ...
                    success: function (res) {
                        ...
                        if (resposta.sucesso === true) {
                            ...
                            if (resposta.redireciona === true) {
                                var url = 'modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_anexos.php?id=' + id_processo;
                            } else {
            ...
            success: function (res) {
                ...
                if (resposta.sucesso === true) {
                    if(resposta.redireciona !== true){
                        ...
                        var url = 'modulo/loja/grande_secretaria/processos/iniciacao/iniciacao_data.php?id=' + id_processo;
                    }
                    $.ajax({
                        url: url,
                        success: function (res) {
