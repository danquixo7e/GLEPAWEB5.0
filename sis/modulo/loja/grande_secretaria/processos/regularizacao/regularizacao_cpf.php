...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/regularizacao/regularizacao.php" class="ajaxify">Regularização</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_cpf.php" class="ajaxify">Abrir Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/regularizacao/regularizacao.php" class="btn btn-outline btn-sm blue ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Regularização
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-icon right"><i class="fa "></i>
                                <input placeholder="Informe o CPF do candidato" type="text" class="form-control mask_cpf" name="cpf" /> </div>
                        </div>
                    </div>
                </div>
            </div>
