...
formCpf.validate({
    ...
    submitHandler: function () {
        ...
        swal({
            ...
            if (isConfirm) {
                formCpf.ajaxSubmit({
                    url: 'modulo/loja/grande_secretaria/processos/regularizacao/control_regularizacao.php',
                    data: {acao: 'sendCpf'},
                    type: 'POST',
                    beforeSend: function () {
                    ...
                    success: function (res) {
                        ...
                        if (resposta.sucesso === true) {
                            ...
                            $.ajax({
                                url: 'modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_dados.php?id=' + resposta.id,
                                success: function (res) {
                    ...
                    success: function (res) {
                        ...
                        if (resposta.sucesso === true) {
                            ...
                            if (resposta.redireciona === true) {
                                var url = 'modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_anexos.php?id=' + id_processo;
                            } else {
            ...
            success: function (res) {
                ...
                if (resposta.sucesso === true) {
                    if(resposta.redireciona !== true){
                        ...
                        var url = 'modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_historico.php?id=' + id_processo;
                    }
                    $.ajax({
                        url: url,
                        success: function (res) {
                ...
                formHistorico.ajaxSubmit({
                    ...
                    success: function (res) {
                        ...
                        if (resposta.sucesso === true) {
                            swal("Enviado!", "Os dados pessoais foram enviados.", "success");
                            if (resposta.redireciona === true) {
                                var url = 'modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_data.php?id=' + id_processo;
                            } else {
                                var url = 'modulo/loja/grande_secretaria/processos/processos.php';
                            }
                            $.ajax({
