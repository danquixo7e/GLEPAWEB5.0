...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $documento; ?>" class="ajaxify">Visualizar Anexo</a>
        </li>
    </ul>
...
<h3 class="page-title"> 
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/regularizacao/regularizacao_anexos.php?id=<?php echo $value['id_processo']; ?>" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Visualizar 
