...
<div class="portlet light portlet-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green bold uppercase">Elevação</span>
        </div>
    </div>
    <div class="portlet-body">
        <div class="mt-element-step">
            <div class="row step-line">
                ...
                <div class="col-md-3 mt-step-col active">
                    ...
                    <div class="mt-step-content font-grey-cascade">Kit para elevação R$ <?php echo number_format(get(glepaweb_tipo_cobranca, id, '3', valor), 2, ',', '.'); ?><br> (Sênior DeMolay está isento) </div>
                </div>
                <div class="col-md-3 mt-step-col active">
                    <div class="mt-step-number bg-white">3</div>
                    <div class="mt-step-title uppercase font-grey-cascade">CONCESSÃO</div>
                    <div class="mt-step-content font-grey-cascade">O Grão-Mestre assina a concessão do Placet para elevação</div>
                </div>
        ...
        <hr>
        <a href="modulo/loja/grande_secretaria/processos/elevacao/elevacao_membros.php" class="btn btn-lg blue margin-top-20 ajaxify"> Iniciar Processo <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
