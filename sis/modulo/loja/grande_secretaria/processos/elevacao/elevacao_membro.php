...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/elevacao/elevacao.php" class="ajaxify">Elevação</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/elevacao/elevacao_membros.php" class="ajaxify">Membros</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/elevacao/elevacao_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
...
<h3 class="page-title">
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/elevacao/elevacao_membros.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Elevação
    <small>Membro</small>
</h3>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_elevacao">
            <div class="portlet-title">
                <div class="caption">
                    <i class=" icon-layers font-green"></i>
                    <span class="caption-subject font-green bold uppercase">Elevação - <span class="step-title"> Passo 1 de 3 </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="formElevacao" name="<?php echo $id; ?>">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> ELEVAÇÃO </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Data do Cerimonial:</label>
    ...
    <script src="modulo/loja/grande_secretaria/processos/elevacao/elevacao.js" type="text/javascript"></script>