...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/filiacaoativo/filiacaoativo_editar.php?id=<?php echo $value['id']; ?>" class="ajaxify">Acessar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if ($value['id_status'] === '3') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaoativo/filiacaoativo_membro.php?id=' . $value['id_membro'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                    ...
                    <td class="table-desc"> Dados pessoais do <?php echo get(glepaweb_membros, id, $value['id_membro'], nome) ;?> e a data do cerimonial de filiação</td>
                    <td class="table-download"><i class="icon-<?php echo ($value['id_status'] !== '3' ? 'like font-blue' : 'clock font-yellow-crusta'); ?> "></i></td>
                </tr>
                <?php
                if ($value['id_status'] > '3') {
                ?>
                <tr>
                    <td class="table-status">
                        ...
                        if ($value['pagamento_taxa'] !== '1') {
                            echo '<a href="modulo/loja/grande_secretaria/processos/filiacaoativo/filiacaoativo_taxa.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
                    ...
                    <td class="table-desc">Taxa referente ao processo de elevação</td>
