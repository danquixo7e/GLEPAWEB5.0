...
<h3 class="page-title"> 
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/filiacaoativo/filiacaoativo.php" class="btn btn-outline btn-sm blue ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Filiação
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        <form class="horizontal-form" name="formFiliacaoAtivoCpf">
...
<script type="text/javascript" src="modulo/loja/grande_secretaria/processos/filiacaoativo/filiacaoativo.js"></script>
