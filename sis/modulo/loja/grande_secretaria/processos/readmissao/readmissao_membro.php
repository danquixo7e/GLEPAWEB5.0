...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/readmissao/readmissao_cpf.php" class="ajaxify">Abrir Processo</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/readmissao/readmissao_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
...
<div class="mt-element-ribbon bg-grey-steel">
    ...
    <p class="ribbon-content">Reconhecemos o processo de exclusão deste membro. Não é necessário enviar o Quite Placet.</p>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_readmissao" name="<?php echo $id; ?>">
            <div class="portlet-title">
                <div class="caption">
                    <i class=" icon-layers font-green"></i>
                    <span class="caption-subject font-green bold uppercase">Readmissão - <span class="step-title"> Passo 1 de 3 </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="formReadmissao" >
