...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/readmissao/readmissao_cpf.php" class="ajaxify">Buscar Membro</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/readmissao/readmissao_quiteplacet_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/readmissao/readmissao_cpf.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Readmissão
    <small>Membro</small>
</h3>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_readmissao_quiteplacet" name="<?php echo $id; ?>">
            <div class="portlet-title">
                <div class="caption">
                    <i class=" icon-layers font-green"></i>
                    <span class="caption-subject font-green bold uppercase">Readmissão - <span class="step-title"> Passo 1 de 4 </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="formReadmissaoQuitePlacet">
                        ...
                        <div class="form-body">
                            <ul class="nav nav-pills nav-justified steps">
                                ...
                                <li>
                                    <a href="#tab2" data-toggle="tab" class="step">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Quite Placet </span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2">
                                    <h3 class="block"><i class="icon-user"></i> <?php echo $value['nome']; ?></h3>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Quite Placet</label>
                                        <div class="col-md-6">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="input-group input-large">
                                                    ...
                                                    <span class="input-group-addon btn default btn-file">
                                                        ...
                                                        <input type="file" name="quite_placet" accept="application/pdf"> </span>
                                                    <a href="javascript:;" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Remover </a>
                                                </div>
                                            </div>
                                            <span class="help-block"> Arquivo em .PDF </span>
                                            <div id="form_arquivo_error"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-medium date date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+7d">
                                                <input type="text" class="form-control" readonly name="data_cerimonial">
                                ...
                                <div class="tab-pane" id="tab4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> READMISSÃO </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Quite Placet:</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static uppercase" data-display="quite_placet"> </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Data do Cerimonial:</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static uppercase text-justify" data-display="data_cerimonial"> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="modulo/loja/grande_secretaria/processos/readmissao/readmissao.js" type="text/javascript"></script>