...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/exaltacao/exaltacao_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
...
<h3 class="page-title">
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/exaltacao/exaltacao_membros.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Exaltação
    <small>Membro</small>
</h3>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_exaltacao">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" id="formExaltacao" name="<?php echo $id; ?>">
    ...
    <script src="modulo/loja/grande_secretaria/processos/exaltacao/exaltacao.js" type="text/javascript"></script>