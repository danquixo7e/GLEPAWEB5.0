...
<h3 class="page-title"> Placet de Exclusão
    <small>Resumo</small>
...
<div class="portlet light portlet-fit bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green bold uppercase">Placet de Exclusão</span>
        </div>
    </div>
        ...
        <div class="mt-element-step">
            <div class="row step-line">
                ...
                <div class="col-md-4 mt-step-col last">
                    ...
                    <div class="mt-step-content font-grey-cascade">A loja imprime a concessão do Placet de Exclusão</div>
                </div>
            </div>
        </div>
        <hr>
        <a href="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao_membros.php" class="btn btn-lg blue margin-top-20 ajaxify"> Iniciar Processo <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
