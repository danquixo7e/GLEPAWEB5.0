...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao.php" class="ajaxify">Placet de Exclusão</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao_membros.php" class="ajaxify">Membros</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao_membro.php?id=<?php echo $id; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
...
<h3 class="page-title">
    <div class="btn-group pull-right">
        <a href="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao_membros.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Placet de Exclusão
    <small>Membro</small>
</h3>
<div class="row">
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_placetdeexclusao">
            <div class="portlet-title">
                <div class="caption">
                    <i class=" icon-layers font-green"></i>
                    <span class="caption-subject font-green bold uppercase">Placet de Exclusão - <span class="step-title"> Passo 1 de 4 </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="formPlacetDeExclusao" name="<?php echo $id; ?>">
                        ...
                        <div class="form-body">
                            <ul class="nav nav-pills nav-justified steps">
                                ...
                                <li>
                                    <a href="#tab3" data-toggle="tab" class="step">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Motivo </span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab3">
                                    <h3 class="block"><i class="icon-user"></i> <?php echo $value['nome']; ?></h3>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Motivo da Exclusão</label>
                                        <div class="col-md-9">
                                            <div class="radio-list text-justify">
                                                <?php
                                                $readMotivo = read('glepaweb_motivos_placet_exclusao');
                                                if ($readMotivo) {
                                                    foreach ($readMotivo as $motivo):
                                                        echo '<label><input ' . ($processo['id_motivo_placet_exclusao'] == $motivo['id'] ? 'checked' : '') . ' type="radio" name="id_motivo_placet_exclusao" value="' . $motivo['id'] . '" data-title="' . $motivo['motivo'] . '" /> ' . $motivo['motivo'] . ' </label>';
                                                        echo '<br>';
                                                    endforeach;
                                                }
                                                ?>
                                            </div>
                                            <div id="form_motivo_error"> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static"> PLACET DE EXCLUSÃO </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Nome Simbólico:</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Motivo da Exclusão:</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static uppercase text-justify" data-display="id_motivo_placet_exclusao"> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="modulo/loja/grande_secretaria/processos/placetdeexclusao/placetdeexclusao.js" type="text/javascript"></script>