        ...
        if($readMembro){
            ...
            if(!$readCpf){
                ...
                if(!$readEmail){
                    ...
                    $p['id_motivo_placet_exclusao'] = filter_input(INPUT_POST, 'id_motivo_placet_exclusao', FILTER_SANITIZE_NUMBER_INT);
                    $p['id_loja'] = $id_loja;
                    $p['id_membro'] = $id;
                    $p['id_tipo'] = '5';
                    $p['id_status'] = '2';
            ...
            $retorno['sucesso'] = false;
            $retorno['mensagem'] = 'Não foi possível solicitar o Placet de Exclusão deste membro';
        }
