...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_editar.php?id=<?php echo $value['id_processo']; ?>" class="ajaxify">Analisar Processo</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos.php?id=<?php echo $value['id_processo']; ?>" class="ajaxify">Anexos</a>
        </li>
    </ul>
...
<h3 class="page-title"> 
    <div class="btn-group pull-right">
        <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_editar.php?id=<?php echo $value['id_processo']; ?>" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
    Iniciação 
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['proposta1'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['proposta1'])) ? 'hide' : '') ?>" id="opcao_proposta1">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['proposta1'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['proposta2'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['proposta2'])) ? 'hide' : '') ?>" id="opcao_proposta2">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['proposta2'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['proposta3'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['proposta3'])) ? 'hide' : '') ?>" id="opcao_proposta3">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['proposta3'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['proposta4'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['proposta4'])) ? 'hide' : '') ?>" id="opcao_proposta4">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['proposta4'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['rg'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['rg'])) ? 'hide' : '') ?>" id="opcao_rg">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['rg'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao'])) ? 'hide' : '') ?>" id="opcao_certidao">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['renda'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['renda'])) ? 'hide' : '') ?>" id="opcao_renda">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['renda'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['medico'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['medico'])) ? 'hide' : '') ?>" id="opcao_medico">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['medico'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao_negativa_judiciario'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao_negativa_judiciario'])) ? 'hide' : '') ?>" id="opcao_certidao_negativa_judiciario">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao_negativa_judiciario'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao_negativa_federal'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao_negativa_federal'])) ? 'hide' : '') ?>" id="opcao_certidao_negativa_federal">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao_negativa_federal'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao_negativa_protesto'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao_negativa_protesto'])) ? 'hide' : '') ?>" id="opcao_certidao_negativa_protesto">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao_negativa_protesto'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['beneficencia'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['beneficencia'])) ? 'hide' : '') ?>" id="opcao_beneficencia">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['beneficencia'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao_demolay'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao_demolay'])) ? 'hide' : '') ?>" id="opcao_certidao_demolay">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao_demolay'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <div class="<?php echo(!($value['certidao_militar'] != '' && file_exists('../../../../../uploads/processos_anexo/' . $value['certidao_militar'])) ? 'hide' : '') ?>" id="opcao_certidao_militar">
                                ...
                                <a href="modulo/grande_secretaria/processos/iniciacao/iniciacao_anexos_exibir.php?id=<?php echo $value['id_processo']; ?>&doc=<?php echo $value['certidao_militar'] ?>" class="btn blue ajaxify"><i class="fa fa-search"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
