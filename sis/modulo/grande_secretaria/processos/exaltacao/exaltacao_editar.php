...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/grande_secretaria/processos/exaltacao/exaltacao_editar.php?id=<?php echo $value['id']; ?>" class="ajaxify">Analisar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title"> 
                ...
                <tr>
                    <td class="table-status">
                        ...
                        if ($value['id_status'] > '1') {
                            echo '<a href="modulo/grande_secretaria/processos/exaltacao/exaltacao_membro.php?id=' . $value['id'] . '" class="ajaxify"><i class="icon-arrow-right font-blue"></i></a>';
                        }
                        ?>
                    </td>
...
<script type="text/javascript" src="modulo/grande_secretaria/processos/exaltacao/exaltacao.js"></script>
