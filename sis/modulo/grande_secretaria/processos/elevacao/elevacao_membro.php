...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/grande_secretaria/processos/elevacao/elevacao_editar.php?id=<?php echo $processo['id']; ?>" class="ajaxify">Analisar Processo</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/grande_secretaria/processos/elevacao/elevacao_membro.php?id=<?php echo $processo['id']; ?>" class="ajaxify">Membro</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    ...
    <div class="col-md-12">
        <div class="portlet light bordered" id="form_wizard_elevacao">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" id="formElevacao" name="<?php echo $processo['id']; ?>">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static">R$ <?php echo number_format(get('glepaweb_tipo_cobranca', id, '3', valor),2,',','.') ;?> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="modulo/grande_secretaria/processos/elevacao/elevacao.js" type="text/javascript"></script>