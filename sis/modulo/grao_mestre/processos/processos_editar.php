...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="modulo/grao_mestre/processos/processos_pendentes.php" class="ajaxify">Processos Pendentes</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="modulo/grao_mestre/processos/processos_editar.php?id=<?php echo $value['id'] ;?>" class="ajaxify">Editar Processo</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    ...
    <div class="btn-group pull-right">
        <a href="modulo/grao_mestre/processos/processos_pendentes.php" class="btn btn-outline blue btn-sm ajaxify"><i class="fa fa-angle-left"></i> Voltar </a>
    </div>
</h3>
<?php
if($value['cancelado'] === '1'){
    echo '<div class="alert alert-warning"><strong>Atenção!</strong> Este processo encontra-se cancelado. </div>';
}
?>
<div class="row">
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                ...
                <div class="actions btn-set">
                    <button class="btn btn-success btn_libera_concessao" <?php echo ($value['cancelado'] === '1' ? 'disabled' : '') ;?> id="<?php echo $value['id'] ;?>">
                        <i class="fa fa-check-circle"></i> Liberar Concessão</button>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li class="divider"> </li>
                            <?php if($value['cancelado'] === '1'){ ?>
                            <li>
                                <a href="javascript:;" class="btn_reativa_processo" id="<?php echo $value['id'] ;?>">
                                    <i class="fa fa-check-square-o"></i> Reativar Processo </a>
                            </li>
                            
                            <?php }else{ ?>
                            <li>
                                <a href="javascript:;" class="btn_cancela_processo" id="<?php echo $value['id'] ;?>">
...
<script type="text/javascript" src="modulo/grao_mestre/processos/processos.js"></script>