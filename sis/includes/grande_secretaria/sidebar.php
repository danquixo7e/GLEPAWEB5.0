    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item  ">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  ">
                        <a href="modulo/grande_secretaria/processos/processos_pendentes.php" class="nav-link ajaxify">
                            <i class="icon-pencil"></i>
                            <span class="title">Processos Pendentes</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="modulo/grande_secretaria/processos/processos_consultar.php" class="nav-link ajaxify">
                            <i class="icon-magnifier"></i>
